...
- Two other useful concepts for managing branches and controlling commit history are `rebase` and `squash`.
...
*Contribution and guidelines are not yet available (to be implemented in the future)*
